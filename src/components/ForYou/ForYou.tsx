        ...
        <div className={`${styles.bec__container}`} id="companies">
            ...
            >
                ...
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent>Партнерство з BEC надає можливість компаніям підвищити свою впізнаваність та популярність серед молоді. Ви зможете налагодити зв'язки з юнацтвом та позиціювати компанію відкритою до нового.
                    </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                    Після завершення випробувальної частини змагань буде проводитись нетворкінг — це подія під час якої студенти та компанії мають змогу неформально поспілкуватись, обмінятись ідеями та досвідом.
                    </AccordionContent>
                </AccordionItem>
...
Участь у командній роботі сприяє обміну креативними ідеями, набуттю цінного досвіду і розвитку комунікаційних навичок.
                ...
                <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                    Тренінги та завдання від компанії, нетворкінг, менторство досвідчених працівників, розв'язування реальних проблем — це все дозволяє набути досвід та стане хорошим стартом власного кар’єрного шляху.
