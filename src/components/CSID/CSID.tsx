...
export default function CSID() {
    ...
    const data = {
        'id': {
            ...
            descr: 'Категорія, у якій від учасників вимагається практичне розв\'язання актуальної задачі в області IoT, embedded, електроніки, радіотехніки чи механіки.',
            stages: {
                ...
                'Другий етап': `створити комп'ютерну модель цього прототипу.`,
        ...
        {
            name: 'Case Study',
            descr: 'Категорія, у якій потрібно запропонувати теоретичне розв\'язання заданої інженерної, економічної, виробничої, соціальної чи маркетингової проблеми.',
            stages: {
                ...
                <div className="flex flex-col lg:flex-row justify-between w-full gap-14 m-6 my-12">
                    ...
                    <div className="flex-1 flex flex-col gap-6">
                        ...
                        <div className="flex flex-col w-full gap-3">
                            ...
                            <p className="text-lg">Категорія, у якій потрібно запропонувати теоретичне розв&apos;язання заданої інженерної, економічної, виробничої, соціальної чи маркетингової проблеми.
                            </p>
                    ...
                    <div className="flex-1 flex flex-col gap-6">
                        ...
                        <div className="flex flex-col w-full gap-3">
                            <img src="/underline.svg" alt="underline" />
                            <p className="text-lg">Категорія, у якій від учасників вимагається практичне розв&apos;язання актуальної задачі в області IoT, embedded, електроніки, радіотехніки чи механіки.
